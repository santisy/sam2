...
function AnnotationView({
  ...
  lastClicked,
  setLastClicked,
  promptBuilderCollapsed,
  setPromptBuilderCollapsed,
  onGeneratePrompt,
  onSaveMask,
  onGoToPrev,
  onGoToNext
  ...
  return (
    <>
      ...
      <div className={`prompt-builder ${promptBuilderCollapsed ? 'collapsed' : 'expanded'}`}>
        <div className="pb-header" onClick={() => setPromptBuilderCollapsed(!promptBuilderCollapsed)}>
          <span>Quick Access Buttons</span>
          <span className="pb-toggle">{promptBuilderCollapsed ? '▼' : '▲'}</span>
        </div>
